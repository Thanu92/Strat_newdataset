...
#This code is to generate stratified sampling using sequential data dropping technique to generate phylogenetic trees at different levels (20%, 40%, 60% and 80%). 
#Followings are the steps to be done with the results of this code (in RAxML, FigTree, RAxMLEPA, iTol, Unix),
#complete tree (100%) and different level backbone trees using RAxML
#Open generated backbone trees using FigTree
#Phylogenetic placement using RAxMLEPA
#Open jplace files generated in RAxMLEPA using iTol online tool
#Change the format of jplace into newick format usig iToL online tool
#Export the newick format (the resultant files should be in the same directory to read the resultant trees into R. The files are named as 20_1_new, 20_2_new etc.)
...
df_frac <- function(df){
  ...
  results <- list(df_80,df_60,df_40,df_20)
}
...
all_df_list <- list(df_1,df_2,df_3,df_4,df_5,df_6,df_7,df_8,df_9,df_10,df_11,df_12,df_13,df_14,df_15,df_16,df_17,df_18,df_19,df_20,df_21,df_22,df_23,df_24,df_25,df_26,df_27,df_28,df_29,df_30,df_31,df_32,df_33,df_34,df_35,df_36,df_37,df_38,df_39,df_40)
...
dataframe2fas(newdf4, file = "20_1S.fasta")
dataframe2fas(newdf8, file = "20_2S.fasta")
dataframe2fas(newdf12, file = "20_3S.fasta")
dataframe2fas(newdf16, file = "20_4S.fasta")
dataframe2fas(newdf20, file = "20_5S.fasta")
dataframe2fas(newdf24, file = "20_6S.fasta")
dataframe2fas(newdf28, file = "20_7S.fasta")
dataframe2fas(newdf32, file = "20_8S.fasta")
dataframe2fas(newdf36, file = "20_9S.fasta")
dataframe2fas(newdf40, file = "20_10S.fasta")


#newdfF1 (multigene 80%) and fishsamplefull_co1_with_speciesname (Co1 100% marker) antijoin to get 20% of co1 that exist only in co1 100% not in multigene 80%
CO1_20_1S <- anti_join(fishsamplefull_co1_with_speciesname,newdf1,by="species_name")
names(newdf2)
names(fishsamplefull_co1_with_speciesname)
CO1_20_2S <- anti_join(fishsamplefull_co1_with_speciesname,newdf5,by="species_name")
CO1_20_3S <- anti_join(fishsamplefull_co1_with_speciesname,newdf9,by="species_name")
CO1_20_4S <- anti_join(fishsamplefull_co1_with_speciesname,newdf13,by="species_name")
CO1_20_5S <- anti_join(fishsamplefull_co1_with_speciesname,newdf17,by="species_name")
CO1_20_6S <- anti_join(fishsamplefull_co1_with_speciesname,newdf21,by="species_name")
CO1_20_7S <- anti_join(fishsamplefull_co1_with_speciesname,newdf25,by="species_name")
CO1_20_8S <- anti_join(fishsamplefull_co1_with_speciesname,newdf29,by="species_name")
CO1_20_9S <- anti_join(fishsamplefull_co1_with_speciesname,newdf33,by="species_name")
CO1_20_10S <- anti_join(fishsamplefull_co1_with_speciesname,newdf37,by="species_name")

CO1_40_1S <- anti_join(fishsamplefull_co1_with_speciesname,newdf2,by="species_name")
CO1_40_2S <- anti_join(fishsamplefull_co1_with_speciesname,newdf6,by="species_name")
CO1_40_3S <- anti_join(fishsamplefull_co1_with_speciesname,newdf10,by="species_name")
CO1_40_4S <- anti_join(fishsamplefull_co1_with_speciesname,newdf14,by="species_name")
CO1_40_5S <- anti_join(fishsamplefull_co1_with_speciesname,newdf18,by="species_name")
CO1_40_6S <- anti_join(fishsamplefull_co1_with_speciesname,newdf22,by="species_name")
CO1_40_7S <- anti_join(fishsamplefull_co1_with_speciesname,newdf26,by="species_name")
CO1_40_8S <- anti_join(fishsamplefull_co1_with_speciesname,newdf30,by="species_name")
CO1_40_9S <- anti_join(fishsamplefull_co1_with_speciesname,newdf34,by="species_name")
CO1_40_10S <- anti_join(fishsamplefull_co1_with_speciesname,newdf38,by="species_name")

CO1_60_1S <- anti_join(fishsamplefull_co1_with_speciesname,newdf3,by="species_name")
CO1_60_2S <- anti_join(fishsamplefull_co1_with_speciesname,newdf7,by="species_name")
CO1_60_3S <- anti_join(fishsamplefull_co1_with_speciesname,newdf11,by="species_name")
CO1_60_4S <- anti_join(fishsamplefull_co1_with_speciesname,newdf15,by="species_name")
CO1_60_5S <- anti_join(fishsamplefull_co1_with_speciesname,newdf19,by="species_name")
CO1_60_6S <- anti_join(fishsamplefull_co1_with_speciesname,newdf23,by="species_name")
CO1_60_7S <- anti_join(fishsamplefull_co1_with_speciesname,newdf27,by="species_name")
CO1_60_8S <- anti_join(fishsamplefull_co1_with_speciesname,newdf31,by="species_name")
CO1_60_9S <- anti_join(fishsamplefull_co1_with_speciesname,newdf35,by="species_name")
CO1_60_10S <- anti_join(fishsamplefull_co1_with_speciesname,newdf39,by="species_name")

CO1_80_1S <- anti_join(fishsamplefull_co1_with_speciesname,newdf4,by="species_name")
CO1_80_2S <- anti_join(fishsamplefull_co1_with_speciesname,newdf8,by="species_name")
CO1_80_3S <- anti_join(fishsamplefull_co1_with_speciesname,newdf12,by="species_name")
CO1_80_4S <- anti_join(fishsamplefull_co1_with_speciesname,newdf16,by="species_name")
CO1_80_5S <- anti_join(fishsamplefull_co1_with_speciesname,newdf20,by="species_name")
CO1_80_6S <- anti_join(fishsamplefull_co1_with_speciesname,newdf24,by="species_name")
CO1_80_7S <- anti_join(fishsamplefull_co1_with_speciesname,newdf28,by="species_name")
CO1_80_8S <- anti_join(fishsamplefull_co1_with_speciesname,newdf32,by="species_name")
CO1_80_9S <- anti_join(fishsamplefull_co1_with_speciesname,newdf36,by="species_name")
CO1_80_10S <- anti_join(fishsamplefull_co1_with_speciesname,newdf40,by="species_name")
...
#Generate fasta files for aligned co1 dataset
dataframe2fas(CO1_20_1S, file = "CO1_20_1S.fasta")
dataframe2fas(CO1_20_2S, file = "CO1_20_2S.fasta")
dataframe2fas(CO1_20_3S, file = "CO1_20_3S.fasta")
dataframe2fas(CO1_20_4S, file = "CO1_20_4S.fasta")
dataframe2fas(CO1_20_5S, file = "CO1_20_5S.fasta")
dataframe2fas(CO1_20_6S, file = "CO1_20_6S.fasta")
dataframe2fas(CO1_20_7S, file = "CO1_20_7S.fasta")
dataframe2fas(CO1_20_8S, file = "CO1_20_8S.fasta")
dataframe2fas(CO1_20_9S, file = "CO1_20_9S.fasta")
dataframe2fas(CO1_20_10S, file = "CO1_20_10S.fasta")
...
#real phylip to convert to fasta to use in epang
getwd()
STR80_1 <- read.phylip("STR80_1.phy")
STR80_2 <- read.phylip("STR80_2.phy")
STR80_3 <- read.phylip("STR80_3.phy")
STR80_4 <- read.phylip("STR80_4.phy")
STR80_5 <- read.phylip("STR80_5.phy")
STR80_6 <- read.phylip("STR80_6.phy")
STR80_7 <- read.phylip("STR80_7.phy")
STR80_8 <- read.phylip("STR80_8.phy")
STR80_9 <- read.phylip("STR80_9.phy")
STR80_10 <- read.phylip("STR80_10.phy")

dat2fasta(STR80_9, outfile = "STR80_9.fasta")
